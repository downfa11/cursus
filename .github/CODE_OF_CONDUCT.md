...
- Is not a declaration intended to eliminate all conflict, and
...
- Criticism and discussion based on technical reasoning
- Respect for participants holding different opinions
- Acknowledging mistakes and correcting them
- Creating issues and pull requests with sufficient context
- Acting with consideration for the long-term sustainability of the project
...
- Do not unnecessarily expand the scope of discussion within a single issue
- Repeated questions, low-effort requests, or pressuring messages may be ignored
